...
1. **Carte Choroplèthe** :
   ...
   ![Carte Choroplèthe](path/to/choropleth-map.png) 
...
2. **Carte Anamorphique** :
   ...
   ![Carte Anamorphique](path/to/anamorphic-map.png) 
...
1. **Graphique à Barres (Bar Plot)** :
   ...
   ![Graphique à Barres](path/to/barplot.png)
...
2. **Graphique d'Évolution (Evolution Plot)** :
   ...
   ![Graphique d'Évolution](path/to/evolution-plot.png)
